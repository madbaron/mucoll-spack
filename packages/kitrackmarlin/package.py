...
class Kitrackmarlin(CMakePackage, Ilcsoftpackage):
    ...
    url = "https://github.com/madbaron/KiTrackMarlin/archive/v01-13.tar.gz"
    homepage = "https://github.com/madbaron/KiTrackMarlin"
    git = "https://github.com/madbaron/KiTrackMarlin.git"

    maintainers("vvolkl")

    version("master", branch="master")
    version("arm-timer-fix", branch="arm-timer-fix")
    version(
        "1.13.2",
